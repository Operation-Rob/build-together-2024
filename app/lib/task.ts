...
export const tasks: Record<string, Task> = {
	...
	robbery: {
		title: 'A robbery',
		task: `You are to simulate a person going through an emergency, so that we may practise emergency dispatching in a simulated, real time environment. Act like someone in an emergency, be frantic when you speak. You've just been robbed, you're distraught and your're calling 000`,
	},
};
